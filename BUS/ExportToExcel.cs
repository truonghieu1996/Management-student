...
namespace BUS
{
    public class ExportToExcel
    {
        ...
        public void Export(DataTable dt, string sheetName, string title)
        {
            ...
            cl7.Value2 = "Tình trạng học thử";

            cl7.ColumnWidth = 20.43;

            Microsoft.Office.Interop.Excel.Range cl8 = oSheet.get_Range("H3", "H3");

            cl8.Value2 = "Kết quả kiểm tra";

            cl8.ColumnWidth = 17.43;
            ...
            //    {
            //        (Microsoft.Office.Interop.Excel.Range)oSheet.Cells[i, j] = "=\"" + arr[i, j] + "\"";
            //    }
            //}
        }
    }
